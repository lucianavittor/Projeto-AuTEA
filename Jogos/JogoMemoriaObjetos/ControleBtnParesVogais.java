...
import view.PrincipalMemoriaVogais;

public class ControleBtnParesVogais {
    ...
    public static List<Integer> rowsTable() {
        ...
        for (int i = 0; i < aumentar; i++) {
            ...
            if (!lista.contains(valor) && lista.size() != 6 && valor != 0) {
                lista.add(valor);
            }
        }
        return lista;
  ...
  //MÉTODO PARA PINTAR AS IMAGENS
    public void paintImage(JButton btn, int valor) {
        try {
            btn.setIcon(new ImageIcon(getClass().getResource("/images/00" + valor + ".png")));
 ...
 // MÉTODO QUE INICIALIZA AS IMAGENS
    public void imgStart() {
        paintImage(PrincipalMemoriaVogais.btn01, 9);
        paintImage(PrincipalMemoriaVogais.btn02, 9);
        paintImage(PrincipalMemoriaVogais.btn03, 9);
        paintImage(PrincipalMemoriaVogais.btn04, 9);
        paintImage(PrincipalMemoriaVogais.btn05, 9);
        paintImage(PrincipalMemoriaVogais.btn06, 9);
        paintImage(PrincipalMemoriaVogais.btn07, 9);
        paintImage(PrincipalMemoriaVogais.btn08, 9);
        paintImage(PrincipalMemoriaVogais.btn09, 9);
        paintImage(PrincipalMemoriaVogais.btn10, 9);
